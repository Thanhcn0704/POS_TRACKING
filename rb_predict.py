...
MODEL_FILE = "robot_time_model.pkl"
...
class RobotTimePredictor:
    ...
    def _load(self, path: str):
        ...
        try:
            ...
            # It requires sklearn to be installed.
            import joblib
            # The following imports are needed for pickle to deserialize the model object.
            from sklearn.linear_model import LinearRegression, Ridge
            from sklearn.preprocessing import PolynomialFeatures
            from sklearn.pipeline import Pipeline

            with open(path, "rb") as f:
                # The .pkl file contains a dictionary: {"model": ..., "metadata": ...}
                data = joblib.load(f)
